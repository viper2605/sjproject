 ...
 * Generated at: 2020-01-22 05:18:40 UTC
...
public final class boardInsert_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginMember == null){ 
      ...
      out.write("\t\t\t\t<!--enctype=\"multipart/form-data\" : 파일 업로드 시 꼮 필요 -->\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<!-- 이미지 크기 다름, 다르게 사용하려고 아래 이미지와 다른 id 사용함. -->\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t<div class=\"form-inline mb-2\">\r\n");
      ...
      out.write("\t    \t// 해당 요소에 files라는 '배열'이 생성되면 저장됨\r\n");
      out.write("\t    \tif(value.files && value.files[0])\r\n");
      out.write("\t    \t\t// 파일이 선택이 된 경우!!   <-- 경로\r\n");
      out.write("\t    \t\tvar reader = new FileReader();\r\n");
      out.write("\t    \t\t\t\t\t\t// 자바에서 제공하는 함수, 경로의 파일을 읽어옴!\r\n");
      out.write("\t    \t\treader.onload = function(e){\r\n");
      out.write("\t    \t\t\tswitch(num){\r\n");
      out.write("\t    \t\t\t\r\n");
      out.write("\t    \t\t\tcase 1: $(\"#titleImg\").prop(\"src\", e.target.result); break // reader.onload 에 result 결과 값이 있음\r\n");
      out.write("\t    \t\t\tcase 2: $(\"#contentImg1\").prop(\"src\", e.target.result); break // reader.onload 에 result 결과 값이 있음\r\n");
      out.write("\t    \t\t\tcase 3: $(\"#contentImg2\").prop(\"src\", e.target.result); break // reader.onload 에 result 결과 값이 있음\r\n");
      out.write("\t    \t\t\tcase 4: $(\"#contentImg3\").prop(\"src\", e.target.result); break // reader.onload 에 result 결과 값이 있음\r\n");
      out.write("\t    \t\t\t\r\n");
      out.write("\t    \t\t\t}\r\n");
      out.write("\t    \t\t}\t\r\n");
      out.write("\t    \t\t// file에서 내용(Content)을 읽어옴\r\n");
      out.write("\t    \t\t// + base64 인코딩 된 경로를 반환 \r\n");
